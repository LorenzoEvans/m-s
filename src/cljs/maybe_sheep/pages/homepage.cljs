...
(def link-styling-home (new-string "h4.pa1.ma1.grow.bw1.f3.near-black.bg-washed-yellow.w-75-m.hover-bg-dark-gray.bb.bw3.br1.hover-washed-green.b--near-black.shadow-3.flex.items-center.justify-center"))
...
(defn portfolio-anchor [] [:a.w-40.mono-gf.o-90.glow {:class link-styling-home :href "http://www.lorenzoevans.me/"} "Portfolio"])
...
(def home-page-nav (new-string "w-100.items-center.flex.flex-row.justify-around.self-center.mb2.flex-column-m.justify-between-m.vh-100-m.vh-25.ba.bw3.b--near-white.shadow3"))
