...
(defn about-page []
  (fn [] [:span.w-100.bw2.b--near-black.overflow-scroll.flex.flex-column.justify-center.vh-100.bg-image-4
          [:h1.f2.avenir.grow.ml1.f4-m.w-100.tc.pa2.near-white.w-90-m.self-center-m "I'm Lorenzo Evans, a developer, musician, writer, thinker and creative."
           ...
           [:div.flex.flex-row.flex-wrap.justify-center.hover-animate
            ...
            [:a.self-center.avenir {:class styles/link-styling-x :href "#/"} "Home"]]))
