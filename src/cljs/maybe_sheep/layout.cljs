...
(defn home-page []
  (fn []
    [:div.w-100.flex.flex-column.justify-around
     [:nav.flex.flex-row.justify-center.w-100.flex-column-m.h-20
      [:a.h2.link.dim.avenir.no-underline.near-black.ba.bw1.b--navy.w5.tc.pa1.ma2 {:href "https://github.com/LorenzoEvans"} "Github"]
      [:a.h2.link.dim.avenir.no-underline.near-black.ba.bw1.b--navy.w5.tc.pa1.ma2 {:href "#"} "Twitter"]
      [:a.h2.link.dim.avenir.no-underline.near-black.ba.bw1.b--navy.w5.tc.pa1.ma2 {:href "#"} "Portfolio"]
      ]
      [:div.flex.flex-column.bg-near-white.br3.bw2.ba.b--near-black.w-75.tc.avenir.navy.f4.pa3.lh-copy.fw2.h-60.self-center.w-75-m.shadow-3.dn-m [:h1..flex.flex-column.justify-center.w-90-m.flex-column-m.bw2.avenir.dark-gray.f-subheadline.ba.b--near-black.bw2.shadow-3.f2-m.hover-bg-dark-gray.hover-near-white.hover-animate.hover-near-black.grow.bg-animate.tc "Maybe Sheeps"]
