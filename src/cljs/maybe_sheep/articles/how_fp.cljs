...
(defn how-fp []
  [:p.avenir.flex.flex-column.pa4.justify-around.content-center.items-center.self-center
   ...
   [:section.flex.flex-column.h-75.w-75
    ...
    [:div.lh-copy
     [:p {:class styles/article-paragraph} 
     ...
     [:p {:class styles/article-paragraph} "The number of hours lost that would have been saved if I had've been able to express to my compiler the nature, the type I expected a function to be working with, and what order, at every stage of it's execution are too great, to many. There was freedom in this strictness. I was free to define as strictly as I pleased, or as loosely I as pleased, the aforementioned criteria of a function. It was then that I resolved to become a Haskeller, and began studying the language, and all things functional programming, and quickly, two things happened: I realized I had fallen into a rabbit-hole, and that there were things way, way stranger than JavaScript that awaited me on this path."]
     [:p {:class styles/article-paragraph} "What I didn't realize, at the time, was that my stay at Hotel Haskell, was going to be much shorter than I intended it to be."]
     [:div {:class styles/article-paragraph} "I was yet to reach my actual destination."]
     [:div {:class styles/article-paragraph} "Where was the next stop?"]
     [:div {:class styles/article-paragraph} "The answer involves the inspiration behind Haskell's list data structure, which, for a data structure that seemed quite normal, that I had such a long standing relationship with,
     ...
     [:div {:class styles/article-paragraph} "The day programming introduced me to Haskell, is only superseded in importance by the day Haskell introduced me to Lisp."]
     [:blockquote.flex.justify-around "For a more in depth rendition of those events, stick around for the next post:"
