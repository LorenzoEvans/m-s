...
(defn how-fp-data []
  [:div.avenir.bg-near-white.flex.flex-column.pa4.w-75.justify-center.ba.b--black.bw2.overflow-auto.h5.content-center.items-center.self-center
   ...
   [:div.flex.flex-column.bg-near-white.w-75.h-100
