    ...
    [:p.avenir.flex.flex-column.pa4.justify-around.content-center.items-center.self-center
     [:section.flex.flex-column.h-75
      ...
      [:p.lh-solid
       ...
       [:p.lh-copy.near-black "So, excitedly, I filled out the application, and waited eagerly for my response, and a few days later, I got an email, saying I'd gotten in, and then, things got real"]
